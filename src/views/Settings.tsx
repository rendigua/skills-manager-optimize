...
export function Settings() {
  ...
  useEffect(() => {
    ...
    api.getSettings("sync_dry_run").then((v) => { if (v) setSyncDryRun(v === "true"); });
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <div className="app-panel overflow-hidden divide-y divide-border-subtle">
            ...
            {/* Migration mode and policy tip */}
            <div className="px-4 py-3 flex items-center justify-between gap-4">
              <div className="min-w-0">
                <h3 className="text-[13px] text-secondary font-medium mb-0.5">{t("settings.migrationMode")}</h3>
                <p className="text-[13px] text-muted">{t("settings.migrationModeDesc")}</p>
                <p className="mt-1 text-[12px] text-faint">{t("settings.policyTip")}</p>
              </div>
            </div>
